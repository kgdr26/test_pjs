...
class LocationController extends Controller
{
    ...
    function datalocation(): object {
        $data = array(
            'title' => 'Dashboard',
        );

        return view('DataLocation.list')->with($data);
    }

    function listdata(Request $request): object{
        $query = DB::table('mst_location as mm')
            ->select(
                'mm.id',
                'mm.name',
                'mm.last_update',
    ...
    function show(Request $request): object{
        $id = $request->id;
        $query = DB::table('mst_location')->select('*')->where('id', $id)->first();
    ...
    function edit(Request $request): object{
        try {
            ...
            DB::table('mst_location')->where('id', $id)->update($data);
